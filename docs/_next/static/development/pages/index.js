...
var _default = _useStateIfMounted["default"];
...
/*!********************************************!*\
  !*** ../use-state-if-mounted/package.json ***!
  \********************************************/
/*! exports provided: name, version, description, author, keywords, main, scripts, license, devDependencies, repository, bugs, homepage, default */
/***/ (function(module) {

module.exports = JSON.parse("{\"name\":\"use-state-if-mounted\",\"version\":\"1.0.2\",\"description\":\"A hook for updating state only if the component is mounted.\",\"author\":{\"name\":\"Nans Dumortier\",\"email\":\"dumortier.nans@gmail.com\",\"url\":\"https://github.com/NansD/\"},\"keywords\":[\"react\",\"hooks\",\"react-hooks\",\"useState\",\"isMounted\"],\"main\":\"index.js\",\"scripts\":{\"build\":\"babel src --out-dir .\",\"bump\":\"npm version\",\"example\":\"cd example && yarn install && yarn package\",\"prepublishOnly\":\"yarn build\",\"watch\":\"nodemon --watch src --exec \\\"yarn build\\\"\"},\"license\":\"MIT\",\"devDependencies\":{\"@babel/cli\":\"^7.8.4\",\"@babel/core\":\"^7.9.0\",\"@babel/preset-env\":\"^7.9.0\",\"@babel/preset-react\":\"^7.9.4\",\"nodemon\":\"^2.0.2\"},\"repository\":{\"type\":\"git\",\"url\":\"https://github.com/NansD/use-state-if-mounted\"},\"bugs\":{\"url\":\"https://github.com/NansD/use-state-if-mounted/issues\"},\"homepage\":\"https://nansd.github.io/use-state-if-mounted/\"}");
...
function Index() {
  ...
  console.log('useStateIfMounted(1) :', Object(_use_state_if_mounted__WEBPACK_IMPORTED_MODULE_3__["useStateIfMounted"])(1));
