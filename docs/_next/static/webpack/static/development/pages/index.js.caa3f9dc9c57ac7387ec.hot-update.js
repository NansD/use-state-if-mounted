...
function Index() {
  ...
  }, "\nconst apiCall = n =>\nnew Promise(resolve => setTimeout(() => resolve(n + 1), 3000));\n\nconst ShowApiCallResult = () => {\nconst [n, setN] = useState(0);\nuseEffect(() => {\n  apiCall(n).then(newN => setN(newN));\n});\n\nreturn String(n);\n};\n\nconst RemoveComponentWithPendingApiCall = () => {\nconst [show, setShow] = useStateIfMounted(true); // notice the change :rocket:\nreturn (\n  <React.Fragment>\n    <button onClick={() => setShow(false)}>Click me</button>\n    {show && <ShowApiCallResult />}\n  </React.Fragment>\n);\n};"))), __jsx("footer", {
    className: "jsx-2272958534",
    __self: this,
    __source: {
      fileName: _jsxFileName,
...
//# sourceMappingURL=index.js.caa3f9dc9c57ac7387ec.hot-update.js.map